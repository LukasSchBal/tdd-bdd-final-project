...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product_without_id(self):
        """It should throw an error while updating a product"""
        product = ProductFactory()
        product.id = None
        product.create()
        self.assertIsNotNone(product.id)
    ...
    def test_deserialize_without_available(self):
        """It should deserialize a product without available"""
        product = ProductFactory()
    ...
    def test_deserialize_invalid_attribute(self):
        """It should deserialize a product invalid attribute"""
        product = ProductFactory()
        data = product.serialize()
